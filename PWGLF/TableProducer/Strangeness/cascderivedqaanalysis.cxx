...
struct CascDerivedQAanalysis {
  ...
  void processMCrec(soa::Join<aod::StraCollisions, aod::StraCents, aod::StraEvSels, aod::StraCollLabels>::iterator const& collision,
                    ...
                    soa::Join<aod::CascMCCores, aod::CascMCCollRefs> const&)
  {
    if (!isEventAccepted(collision, true)) {
      return;
    }
  ...
  void processMCgen(soa::Join<aod::StraMCCollisions, aod::StraMCCollMults>::iterator const& mcCollision, 
